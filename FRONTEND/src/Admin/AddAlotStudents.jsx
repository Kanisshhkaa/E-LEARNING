...
export default function AddAlotStudents(){
    ...
    const addData=(e)=>{
        ...
        ApiServices.addAlotStudents(data)
        .then((res)=>{
      ...
      <div className="row justify-content-center">
        <div className="col-md-6">
          <div className="contact-content-holder text-center py-2 mb-4">
            <h1 className="fs-3 fw-strong">Alot Students</h1>
      ...
      <div className="row justify-content-center">
        <div className="col-md-6">
            <form onSubmit={addData} style={{backgroundColor:'#8fbc8f',padding:'30px 30px'}} className="rounded-2">
                ...
                <select required className="form-control" onChange={(e)=>{setstudentId(e.target.value)}} >
                ...
                <select required className="form-control" onChange={(e)=>{setcourseId(e.target.value)}} >
