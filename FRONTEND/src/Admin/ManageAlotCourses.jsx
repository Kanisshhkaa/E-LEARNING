...
export default function ManageAlotCourses(){
    const[data,setdata]=useState([])
    const[isDelete,setIsDelte]=useState(false)

    useEffect(()=>{
        ApiServices.getAlotCourses()
       ...
       const deleteData = (id)=>{
           ...
           ApiServices.deleteAlotCourses(data)
         .then((res)=>{
      ...
      <div className="row justify-content-center">
        <div className="col-md-6">
          <div className="contact-content-holder text-center py-2 mb-4">
            <h1 className="fs-3 fw-strong">Manage Alot Courses</h1>
             ...
             <tbody>
               {
                   data.map((el,index)=>(
                       ...
                       <tr>
                        ...
                        <td>
                        <Link to={"/admin/updatealotcourses/" + el._id}>
