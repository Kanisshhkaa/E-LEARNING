...
export default function ViewCourses() {
  ...
  useEffect(() => {
    ...
    ApiServices.getCourseData(data)
      .then((res) => {
  ...
  let addBookingData = (courseId, price) => {
    let data = {
          ...
          <div className="row justify-content-center">
            <div className="col-12 d-flex flex-wrap justify-content-center">

              {
                ...
                <div className="card me-3 mb-3" key={el._id} style={{ width: "22rem", display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                  ...
                  <div className="card-body d-flex flex-column">
                    ...
                    <div className="col-12">
                      ...
                      {token && (
                        <button
                          onClick={() => addBookingData(el._id, el.price)}
                          className="btn btn-sm btn-success rounded ms-4 shadow-sm small d-inline-flex align-item-center"
                        >
                          Book Now
                        </button>
                      )}
